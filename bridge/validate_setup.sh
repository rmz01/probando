...
echo "  ${GREEN}python3 esp32_to_fomalhaut_bridge.py${NC}"
echo ""
echo "Para probar sin hardware (simulación):"
echo "  ${BLUE}python3 simulate_esp32.py${NC}"
echo ""
echo "Para ver más información:"
echo "  ${BLUE}cat README.md${NC}"
echo "  ${BLUE}cat ARCHITECTURE.md${NC}"
echo "  ${BLUE}cat BACKEND_SPEC.md${NC}"
echo ""
