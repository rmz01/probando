...
echo "  python3 esp32_to_fomalhaut_bridge.py${NC}"
echo ""
echo "Para probar sin hardware (simulación):"
echo "  python3 simulate_esp32.py${NC}"
echo ""
echo "Para ver más información:"
echo "  cat README.md${NC}"
echo "  cat ARCHITECTURE.md${NC}"
echo "  cat BACKEND_SPEC.md${NC}"
echo ""
